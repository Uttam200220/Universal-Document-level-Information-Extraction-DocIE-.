...
res_file = "input/res/results.json"        # predictions from notebook
ref_file = "input/ref/reference.json"      # ground truth from notebook
output_dir = "outputs"                      # where scores.json will be written
